...
app.post('/addUser', (req, res) => {
  const {nombre, edad, direccion, telefono, avatar, username, password} = req.body
  ...
  res.send('Usuario guardado'+ ' ' + nombre + ' ' + edad + ' ' + direccion + ' ' + telefono + ' ' + avatar + ' ' + username + ' ' + password)
})
